...
export const sendvalidationEmail = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const verifiyEmail = async (req: Request, res: Response, next: NextFunction) => {
    try {
